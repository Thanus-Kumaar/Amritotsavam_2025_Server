/*
  ...
  ===========================================================================
  Purpose:
    This schema defines the structure for the Amritotsavam database.
...
('CSE & Cyber', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('ECE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('EEE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('Int. Sciences & Mass Communication', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('Chemical, Civil & Aero', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('MEE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
