...
<body>
    <div class="container">
        ...
        <div class="sub-header">Immerse Yourself in a Weekend of Culture, Creativity, and Connection</div>

        <p>Hello <strong>${userName}</strong>,</p>

        <p>Welcome to Amritotsavam 2025! We’re excited to have you on board.</p>
