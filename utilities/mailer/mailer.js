...
export const sendRegistrationOTP = async (userName, OTP, userEmail) => {
    const mailSubject =
        "Amritotsavam 2025 - Account Registration - [OTP Verification]";
...
export const sendForgotPasswordOtp = async (userName, OTP, userEmail) => {
    const mailSubject = "Amritotsavam 2025 - Forgot Password - [OTP Verification]";
...
export const sendEventRegistrationCompleteOtp = async (
    ...
    const mailSubject = "Amritotsavam 2025 - Event Registration Mail";
...
export const sendAnnouncementMail = async (
    ...
    const mailSubject = "Amritotsavam 2025 - Announcement";
...
export const sendEventMail = async (
    ...
    const mailSubject = "Amritotsavam 2025 - " + eventName + " Event Announcement";
